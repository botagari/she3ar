...
const الرابط = [
     'https://discord.gg/FGhkMds'
]
   client.on('message', message => {
 if (message.content.startsWith("الرابط")) {
     if(!message.channel.guild) return message.reply('** This command only for servers **');
  var client= new Discord.RichEmbed()
  .setTitle("رابط الكلان..")
  .setColor('RANDOM')
  .setDescription(`${الرابط[Math.floor(Math.random() * الرابط.length)]}`)
...
const باك = [
 ...
 client.on('message', message => {
  ...
  .setColor('RANDOM')
   .setThumbnail(message.author.avatarURL) 
 .addField('Plus Bot' ,
  `${باك[Math.floor(Math.random() * باك.length)]}`)
...
const يرب = [
 ...
 client.on('message', message => {
   if (message.content.startsWith("يرب")) {
                if(!message.channel.guild) return message.reply('** This command only for servers**');
  var embed = new Discord.RichEmbed()
  .setColor('RANDOM')
   .setThumbnail(message.author.avatarURL) 
 .addField('لعبه قت كويت' ,
